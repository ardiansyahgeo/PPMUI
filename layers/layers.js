...
var format_StrukturGeologi_16 = new ol.format.GeoJSON();
var features_StrukturGeologi_16 = format_StrukturGeologi_16.readFeatures(json_StrukturGeologi_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_StrukturGeologi_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_StrukturGeologi_16.addFeatures(features_StrukturGeologi_16);
var lyr_StrukturGeologi_16 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_StrukturGeologi_16, 
                style: style_StrukturGeologi_16,
                interactive: true,
    title: 'Struktur Geologi<br />\
    <img src="styles/legend/StrukturGeologi_16_0.png" /> Kelurusan<br />\
    <img src="styles/legend/StrukturGeologi_16_1.png" /> Lipatan<br />\
    <img src="styles/legend/StrukturGeologi_16_2.png" /> Patahan<br />'
        });
var format_TitikGempa5magTahun902022_17 = new ol.format.GeoJSON();
var features_TitikGempa5magTahun902022_17 = format_TitikGempa5magTahun902022_17.readFeatures(json_TitikGempa5magTahun902022_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TitikGempa5magTahun902022_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TitikGempa5magTahun902022_17.addFeatures(features_TitikGempa5magTahun902022_17);
var lyr_TitikGempa5magTahun902022_17 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_TitikGempa5magTahun902022_17, 
                style: style_TitikGempa5magTahun902022_17,
                interactive: true,
    title: 'Titik Gempa >5 mag (Tahun 90-2022)<br />\
    <img src="styles/legend/TitikGempa5magTahun902022_17_0.png" /> 5 - 5,5 mag<br />\
    <img src="styles/legend/TitikGempa5magTahun902022_17_1.png" /> 5,5 - 6 mag<br />\
    <img src="styles/legend/TitikGempa5magTahun902022_17_2.png" /> 6 - 6,5 mag<br />\
    <img src="styles/legend/TitikGempa5magTahun902022_17_3.png" /> 6,5 - 6,82 mag<br />'
        });
var format_BANGUNAN1LANTAI_18 = new ol.format.GeoJSON();
var features_BANGUNAN1LANTAI_18 = format_BANGUNAN1LANTAI_18.readFeatures(json_BANGUNAN1LANTAI_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BANGUNAN1LANTAI_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BANGUNAN1LANTAI_18.addFeatures(features_BANGUNAN1LANTAI_18);
var lyr_BANGUNAN1LANTAI_18 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_BANGUNAN1LANTAI_18, 
                style: style_BANGUNAN1LANTAI_18,
                interactive: true,
                title: '<img src="styles/legend/BANGUNAN1LANTAI_18.png" /> BANGUNAN >1 LANTAI'
            });
var format_TEMPATEVAKUASIAKHIRTEA_19 = new ol.format.GeoJSON();
var features_TEMPATEVAKUASIAKHIRTEA_19 = format_TEMPATEVAKUASIAKHIRTEA_19.readFeatures(json_TEMPATEVAKUASIAKHIRTEA_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TEMPATEVAKUASIAKHIRTEA_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TEMPATEVAKUASIAKHIRTEA_19.addFeatures(features_TEMPATEVAKUASIAKHIRTEA_19);
var lyr_TEMPATEVAKUASIAKHIRTEA_19 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_TEMPATEVAKUASIAKHIRTEA_19, 
                style: style_TEMPATEVAKUASIAKHIRTEA_19,
                interactive: true,
                title: '<img src="styles/legend/TEMPATEVAKUASIAKHIRTEA_19.png" /> TEMPAT EVAKUASI AKHIR (TEA)'
            });
var format_TitikBangunan1LantaiHasilPMap_20 = new ol.format.GeoJSON();
var features_TitikBangunan1LantaiHasilPMap_20 = format_TitikBangunan1LantaiHasilPMap_20.readFeatures(json_TitikBangunan1LantaiHasilPMap_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_TitikBangunan1LantaiHasilPMap_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_TitikBangunan1LantaiHasilPMap_20.addFeatures(features_TitikBangunan1LantaiHasilPMap_20);
var lyr_TitikBangunan1LantaiHasilPMap_20 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_TitikBangunan1LantaiHasilPMap_20, 
                style: style_TitikBangunan1LantaiHasilPMap_20,
                interactive: true,
                title: '<img src="styles/legend/TitikBangunan1LantaiHasilPMap_20.png" /> Titik Bangunan >1 Lantai (Hasil P-Map)'
            });
var format_BatasDesaKelurahan_21 = new ol.format.GeoJSON();
var features_BatasDesaKelurahan_21 = format_BatasDesaKelurahan_21.readFeatures(json_BatasDesaKelurahan_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BatasDesaKelurahan_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BatasDesaKelurahan_21.addFeatures(features_BatasDesaKelurahan_21);
var lyr_BatasDesaKelurahan_21 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_BatasDesaKelurahan_21, 
                style: style_BatasDesaKelurahan_21,
                interactive: true,
                title: '<img src="styles/legend/BatasDesaKelurahan_21.png" /> Batas Desa/Kelurahan'
            });

lyr_google_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_HYBRID_2.setVisible(true);lyr_INDEKSBAHAYABANJIRINARISKBNPB_3.setVisible(false);lyr_INDEKSBAHAYATSUNAMIINARISKBNPB_4.setVisible(false);lyr_INDEKSBAHAYAGEMPABUMIINARISKBNPB_5.setVisible(false);lyr_INDEKSBAHAYALONSGORINARISKBNPB_6.setVisible(false);lyr_WILAYAHRAWANTSUNAMIAnalisisDemnas_7.setVisible(false);lyr_JANGKAUANTESUNTUKLANSIA39Menit_8.setVisible(false);lyr_JANGKAUANTESSESEORANGDENGANANAK39Menit_9.setVisible(false);lyr_JANGKAUANTESUNTUKMENDORONGKERETA39Menit_10.setVisible(false);lyr_JANGKAUANTESUNTUKLANSIA15Menit_11.setVisible(false);lyr_JANGKAUANTESSESEORANGDENGANANAK15Menit_12.setVisible(false);lyr_JANGKAUANTESUNTUKMENDORONGKERETA15Menit_13.setVisible(false);lyr_JANGKAUANMENUJUTEA_14.setVisible(true);lyr_RuteEvakuasi_15.setVisible(true);lyr_StrukturGeologi_16.setVisible(true);lyr_TitikGempa5magTahun902022_17.setVisible(true);lyr_BANGUNAN1LANTAI_18.setVisible(true);lyr_TEMPATEVAKUASIAKHIRTEA_19.setVisible(true);lyr_TitikBangunan1LantaiHasilPMap_20.setVisible(true);lyr_BatasDesaKelurahan_21.setVisible(true);
var layersList = [lyr_google_0,lyr_OpenStreetMap_1,lyr_HYBRID_2,lyr_INDEKSBAHAYABANJIRINARISKBNPB_3,lyr_INDEKSBAHAYATSUNAMIINARISKBNPB_4,lyr_INDEKSBAHAYAGEMPABUMIINARISKBNPB_5,lyr_INDEKSBAHAYALONSGORINARISKBNPB_6,lyr_WILAYAHRAWANTSUNAMIAnalisisDemnas_7,lyr_JANGKAUANTESUNTUKLANSIA39Menit_8,lyr_JANGKAUANTESSESEORANGDENGANANAK39Menit_9,lyr_JANGKAUANTESUNTUKMENDORONGKERETA39Menit_10,lyr_JANGKAUANTESUNTUKLANSIA15Menit_11,lyr_JANGKAUANTESSESEORANGDENGANANAK15Menit_12,lyr_JANGKAUANTESUNTUKMENDORONGKERETA15Menit_13,lyr_JANGKAUANMENUJUTEA_14,lyr_RuteEvakuasi_15,lyr_StrukturGeologi_16,lyr_TitikGempa5magTahun902022_17,lyr_BANGUNAN1LANTAI_18,lyr_TEMPATEVAKUASIAKHIRTEA_19,lyr_TitikBangunan1LantaiHasilPMap_20,lyr_BatasDesaKelurahan_21];
...
lyr_StrukturGeologi_16.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'fcode': 'fcode', 'namobj': 'namobj', 'klsstr': 'klsstr', 'remark': 'remark', 'Shape_Leng': 'Shape_Leng', });
lyr_TitikGempa5magTahun902022_17.set('fieldAliases', {'time': 'time', 'latitude': 'latitude', 'longitude': 'longitude', 'depth': 'depth', 'mag': 'mag', 'magType': 'magType', 'nst': 'nst', 'gap': 'gap', 'dmin': 'dmin', 'rms': 'rms', 'net': 'net', 'id': 'id', 'updated': 'updated', 'place': 'place', 'type': 'type', 'horizontal': 'horizontal', 'depthError': 'depthError', 'magError': 'magError', 'magNst': 'magNst', 'status': 'status', 'locationSo': 'locationSo', 'magSource': 'magSource', });
lyr_BANGUNAN1LANTAI_18.set('fieldAliases', {'Name': 'Name', 'Tinggi_Ban': 'Tinggi_Ban', 'arah': 'arah', 'FOTO': 'FOTO', });
lyr_TEMPATEVAKUASIAKHIRTEA_19.set('fieldAliases', {'Name': 'Name', 'pdfmaps_ph': 'pdfmaps_ph', 'Kemiringan': 'Kemiringan', 'Keterangan': 'Keterangan', 'Kondisi_Ba': 'Kondisi_Ba', 'Kondisi_Ja': 'Kondisi_Ja', 'Lebar_Bang': 'Lebar_Bang', 'Lebar_Jala': 'Lebar_Jala', 'Nama': 'Nama', 'Panjang_Ja': 'Panjang_Ja', 'Tinggi_Ban': 'Tinggi_Ban', 'Tipe': 'Tipe', 'row_num': 'row_num', 'arah': 'arah', 'FOTO': 'FOTO', });
lyr_TitikBangunan1LantaiHasilPMap_20.set('fieldAliases', {'OID_': 'OID_', 'Name': 'Name', 'Kecamatan': 'Kecamatan', });
lyr_BatasDesaKelurahan_21.set('fieldAliases', {'NAMOBJ': 'Nama Obyek', 'WADMKC': 'Kecamatan', 'WADMKD': 'Kelurahan/Desa', 'jumlah_kk': 'Jumlah KK', 'pria': 'Jumlah Pria', 'wanita': 'Jumlah Wanita', 'Balita': 'Jumlah Balita', 'lansia': 'Jumlah Lansia', });
...
lyr_StrukturGeologi_16.set('fieldImages', {'OBJECTID': 'TextEdit', 'fcode': 'TextEdit', 'namobj': 'TextEdit', 'klsstr': 'TextEdit', 'remark': 'TextEdit', 'Shape_Leng': 'TextEdit', });
lyr_TitikGempa5magTahun902022_17.set('fieldImages', {'time': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'depth': 'TextEdit', 'mag': 'TextEdit', 'magType': 'TextEdit', 'nst': 'TextEdit', 'gap': 'TextEdit', 'dmin': 'TextEdit', 'rms': 'TextEdit', 'net': 'TextEdit', 'id': 'TextEdit', 'updated': 'TextEdit', 'place': 'TextEdit', 'type': 'TextEdit', 'horizontal': 'TextEdit', 'depthError': 'TextEdit', 'magError': 'TextEdit', 'magNst': 'TextEdit', 'status': 'TextEdit', 'locationSo': 'TextEdit', 'magSource': 'TextEdit', });
lyr_BANGUNAN1LANTAI_18.set('fieldImages', {'Name': 'TextEdit', 'Tinggi_Ban': 'TextEdit', 'arah': 'TextEdit', 'FOTO': 'ExternalResource', });
lyr_TEMPATEVAKUASIAKHIRTEA_19.set('fieldImages', {'Name': 'TextEdit', 'pdfmaps_ph': 'TextEdit', 'Kemiringan': 'TextEdit', 'Keterangan': 'TextEdit', 'Kondisi_Ba': 'TextEdit', 'Kondisi_Ja': 'TextEdit', 'Lebar_Bang': 'TextEdit', 'Lebar_Jala': 'TextEdit', 'Nama': 'TextEdit', 'Panjang_Ja': 'TextEdit', 'Tinggi_Ban': 'TextEdit', 'Tipe': 'TextEdit', 'row_num': 'TextEdit', 'arah': 'TextEdit', 'FOTO': 'TextEdit', });
lyr_TitikBangunan1LantaiHasilPMap_20.set('fieldImages', {'OID_': 'TextEdit', 'Name': 'TextEdit', 'Kecamatan': 'TextEdit', });
lyr_BatasDesaKelurahan_21.set('fieldImages', {'NAMOBJ': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKD': 'TextEdit', 'jumlah_kk': 'TextEdit', 'pria': 'TextEdit', 'wanita': 'TextEdit', 'Balita': 'Range', 'lansia': 'Range', });
...
lyr_StrukturGeologi_16.set('fieldLabels', {'OBJECTID': 'no label', 'fcode': 'no label', 'namobj': 'no label', 'klsstr': 'no label', 'remark': 'no label', 'Shape_Leng': 'no label', });
lyr_TitikGempa5magTahun902022_17.set('fieldLabels', {'time': 'inline label', 'latitude': 'inline label', 'longitude': 'inline label', 'depth': 'inline label', 'mag': 'inline label', 'magType': 'inline label', 'nst': 'inline label', 'gap': 'inline label', 'dmin': 'inline label', 'rms': 'inline label', 'net': 'inline label', 'id': 'inline label', 'updated': 'inline label', 'place': 'inline label', 'type': 'inline label', 'horizontal': 'inline label', 'depthError': 'inline label', 'magError': 'inline label', 'magNst': 'inline label', 'status': 'inline label', 'locationSo': 'inline label', 'magSource': 'inline label', });
lyr_BANGUNAN1LANTAI_18.set('fieldLabels', {'Name': 'inline label', 'Tinggi_Ban': 'inline label', 'arah': 'inline label', 'FOTO': 'inline label', });
lyr_TEMPATEVAKUASIAKHIRTEA_19.set('fieldLabels', {'Name': 'inline label', 'pdfmaps_ph': 'inline label', 'Kemiringan': 'inline label', 'Keterangan': 'inline label', 'Kondisi_Ba': 'inline label', 'Kondisi_Ja': 'inline label', 'Lebar_Bang': 'inline label', 'Lebar_Jala': 'inline label', 'Nama': 'inline label', 'Panjang_Ja': 'inline label', 'Tinggi_Ban': 'inline label', 'Tipe': 'inline label', 'row_num': 'inline label', 'arah': 'inline label', 'FOTO': 'inline label', });
lyr_TitikBangunan1LantaiHasilPMap_20.set('fieldLabels', {'OID_': 'inline label', 'Name': 'inline label', 'Kecamatan': 'inline label', });
lyr_BatasDesaKelurahan_21.set('fieldLabels', {'NAMOBJ': 'inline label', 'WADMKC': 'inline label', 'WADMKD': 'inline label', 'jumlah_kk': 'inline label', 'pria': 'inline label', 'wanita': 'inline label', 'Balita': 'inline label', 'lansia': 'inline label', });
lyr_BatasDesaKelurahan_21.on('precompose', function(evt) {
